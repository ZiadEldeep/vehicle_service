    ...
    <div class="col-12">
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="form-group">
                    <label for="contact" class="control-label">Owner Phone</label>
                    <input type="text" name="contact" id="contact" class="form-control form-control-sm rounded-0" required>
                </div>
                <div class="form-group">
                    <label for="email" class="control-label">Owner E-mail</label>
        ...
        <div class="w-100 d-flex justify-content-end mx-2">
            <div class="col-auto">
                <button class="btn btn-primary btn-sm rounded-0">Submit</button>
